...
<html>
    <head>
        ...
        %>
        <script >
            function llenar(idE,nombre,dui,nit,licencia,direccion,tel){
                document.frm.txtId.value = idE;
                ...
                document.frm.txtTelefono.value = tel;
            }
            
            /*
            function Valdui() {
                // var dui = document.frm.txtDui;
                var dui = document.getElementById("iddui").value;
                if (!(/^\d{8}-\d{1}$/.test(dui))) {
                        alert('DUI no valido');
                        return fal - se;
                        /^\d{4}
    ...
    <center>
        ...
        <form name="frm" action="procesarEmpleado" method="POST">
            ...
            <table >
                ...
                <tr>
                    <td>DUI</td><td><input type="text" name="txtDui" id="iddui" onblur="Valdui()"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Licencia</td><td>
                        <!--<input type="text" name="txtLicencia"></td>-->
